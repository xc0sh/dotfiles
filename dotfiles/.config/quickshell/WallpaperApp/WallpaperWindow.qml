...
PanelWindow {
    ...
    property string defaultWallpaperFolder: Quickshell.env("HOME") + "/Pictures/wallpaper"
    property string wallpaperSettingFile: Quickshell.env("HOME") + "/.config/xcloud/settings/wallpaper-folder"
    ...
    property string transitionEffectSettingFile: Quickshell.env("HOME") + "/.config/xcloud/settings/wallpaper-transition-effect"
    ...
    component xCloudComboBox: ComboBox {
        ...
        delegate: ItemDelegate {
            id: itemDelegate
            width: xcloudComboBox.width
            contentItem: Text {
                text: xcloudComboBox.textRole ? (modelData[xcloudComboBox.textRole] ?? "") : modelData
            ...
            highlighted: xcloudComboBox.highlightedIndex === index
        }
        contentItem: Text {
            leftPadding: 12
            rightPadding: xcloudComboBox.indicator.width + 12
            text: xcloudComboBox.displayText
            font.family: Theme.fontFamily
            font.pixelSize: 14
            color: Theme.primary
            verticalAlignment: Text.AlignVCenter
        ...
        indicator: Canvas {
            id: canvas
            x: xcloudComboBox.width - width - 12
            y: (xcloudComboBox.height - height) / 2
            width: 12
            height: 8
            contextType: "2d"
        ...
        popup: Popup {
            ...
            contentItem: ListView {
                ...
                model: xcloudComboBox.popup.visible ? xcloudComboBox.delegateModel : null
                currentIndex: xcloudComboBox.highlightedIndex
    ...
    component xCloudCheckBox : CheckBox {
        ...
        indicator: Rectangle {
            implicitWidth: 18
            implicitHeight: 18
            x: xcloudCheckBox.leftPadding
            y: (xcloudCheckBox.height - height) / 2
            radius: 4
            border.color: Theme.primary
            border.width: 1
            color: "transparent"
            Rectangle {
                ...
                anchors.centerIn: parent
                color: Theme.primary
                visible: xcloudCheckBox.checked
            }
        }
        contentItem: Text {
            text: xcloudCheckBox.text
            font.family: Theme.fontFamily
            color: Theme.primary
            font.pixelSize: 14
            verticalAlignment: Text.AlignVCenter
            leftPadding: xcloudCheckBox.indicator.width + xcloudCheckBox.spacing
        }
    }
                ...
                SettingsWheel {
                    ...
                    Menu {
                        ...
                        xCloudMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/xcloud/scripts/xcloud-wallpaper --random"])
                            } 
                        }
                        ...
                        xCloudMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/xcloud/scripts/xcloud-wallpaper-effects"])
                            } 
                        }
                        ...
                        xCloudMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/xcloud/scripts/xcloud-clear-wallpaper-cache"])
                            } 
                        }
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                let scriptPath = Quickshell.env("HOME") + "/.config/xcloud/scripts/xcloud-wallpaper";
                                let options = ""
                                if (advancedOptions.visible) {
