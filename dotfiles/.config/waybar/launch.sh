...
default_theme="/xcloud-glass-center;/xcloud-glass-center/default"

# -----------------------------------------------------
# Remove incompatible themes
# -----------------------------------------------------

if [ -f ~/.config/xcloud/settings/waybar-theme.sh ]; then
    themestyle=$(cat ~/.config/xcloud/settings/waybar-theme.sh)
    case "$themestyle" in
    "/xcloud-modern;/xcloud-modern/light")
        echo "$default_theme" >~/.config/xcloud/settings/waybar-theme.sh
        ;;
    "/xcloud-modern;/xcloud-modern/dark")
        echo "$default_theme" >~/.config/xcloud/settings/waybar-theme.sh
        ;;
    "/xcloud;/xcloud/light")
        echo "$default_theme" >~/.config/xcloud/settings/waybar-theme.sh
...
# -----------------------------------------------------
# Get current theme information from ~/.config/xcloud/settings/waybar-theme.sh
# -----------------------------------------------------

if [ -f ~/.config/xcloud/settings/waybar-theme.sh ]; then
    themestyle=$(cat ~/.config/xcloud/settings/waybar-theme.sh)
else
    touch ~/.config/xcloud/settings/waybar-theme.sh
    echo "$default_theme" >~/.config/xcloud/settings/waybar-theme.sh
...
_toggle_module "custom/appmenu" "$HOME/.config/xcloud/settings/waybar_appmenu.sh"
_toggle_module "wlr/taskbar" "$HOME/.config/xcloud/settings/waybar_taskbar.sh"
_toggle_module "group/quicklinks" "$HOME/.config/xcloud/settings/waybar_quicklinks.sh"
_toggle_module "hyprland/window" "$HOME/.config/xcloud/settings/waybar_window.sh"
_toggle_module "network" "$HOME/.config/xcloud/settings/waybar_network.sh"
_toggle_module "tray" "$HOME/.config/xcloud/settings/waybar_systray.sh"
